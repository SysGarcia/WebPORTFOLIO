            ...
            <h2 className="font-semibold flex items-center text-2xl ml-6">
                ...
                >
                    ...
                    <ul className="h-svh flex header:hidden flex-col justify-center items-center gap-2 text-lg text-text_primary">
                        ...
                        <NavItemHamMenu id="blog" link="/blog" name="Blog" icon='<svg class="fill-text_primary" width="19px" height="19px" viewBox="0 0 2.88 2.88" xmlns="http://www.w3.org/2000/svg"><title/><g><path d="M0.36 2.16a0.36 0.36 0 1 0 0.36 0.36 0.36 0.36 0 0 0 -0.36 -0.36"/><path d="M0.36 1.08a0.18 0.18 0 0 0 0 0.36 1.081 1.081 0 0 1 1.08 1.08 0.18 0.18 0 0 0 0.36 0 1.441 1.441 0 0 0 -1.44 -1.44"/><path d="M0.36 0a0.18 0.18 0 0 0 0 0.36 2.162 2.162 0 0 1 2.16 2.16 0.18 0.18 0 0 0 0.36 0A2.523 2.523 0 0 0 0.36 0"/></g></svg>' />
                        <NavItemHamMenu id="contact" link="/contact" name="Contacto" current={current_page} icon='<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle class="stroke-text_primary" cx="12" cy="7" r="5" stroke="#fff" stroke-width="2"/><path class="stroke-text_primary" d="M17 14H17.3517C18.8646 14 20.1408 15.1266 20.3285 16.6279L20.719 19.7519C20.8682 20.9456 19.9374 22 18.7344 22H5.26556C4.06257 22 3.1318 20.9456 3.28101 19.7519L3.67151 16.6279C3.85917 15.1266 5.13538 14 6.64835 14H7" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>' />
                    </ul>
                </nav>
                ...
                <ul className="hidden header:flex items-center gap-6 mr-6">
                    ...
                    <NavItem id="skills_mobile" link="/skills" name="Habilidades"/>
                    <NavItem id="blog_mobile" link="/blog" name="Blog"/>
                    <NavItem id="contact_mobile" link="/contact" name="Contacto"/>
                    {/*
